...
object DatabaseWS {;import org.scalaide.worksheet.runtime.library.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(82); 
  ...
  ParseExpr.parse("print dictionary;");$skip(63); 
